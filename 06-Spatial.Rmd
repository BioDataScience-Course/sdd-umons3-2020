...
if (exists("assignation"))
  assignation("C06Ga_map", 
    url = "https://github.com/BioDataScience-Course/C06Ga_bees_belgium",
    course.urls = c(
      'S-BIOG-025' = "https://classroom.github.com/a/8MUsrDBK"),
    toc = "Distribution des abeilles sauvages de Belgique")
```
