...
Avant de vous lancer dans la création d'un package, il faut lui trouver un nom. Le choix du nom d'un package est compliqué. Il est cependant possible d'employer la fonction available() pour vous aider
