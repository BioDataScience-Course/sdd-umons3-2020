...
assignation("C03Gb_challenge", part = NULL,
  ...
  course.urls = c(
    'S-BIOG-025' = "https://classroom.github.com/g/zFsIcGjF"),
  toc = "Challenge pour trouver les meilleurs vins")
```

Vous pourrez soumettre vos résultats via le formulaire ci-dessous. Utilisez le bouton `Submit` pour tester votre soumission et le bouton `Quit & Save` pour envoyer votre solution au challenge et le faire apparaître dans le tableau de classement. Pour soumettre un autre modèle, relancez l'app de soumission avec `Reload`\ :

<!-- launch_shiny("https://sdd.umons.ac.be/B01Sa_reglin/", height = 600, delay = 20, toc = "Ajuster la meilleure droite")`-->

<iframe width="780" height="500" frameborder="0" scrolling="auto" class="shiny-app" id=\"C03Sa_ml_challenge\" src="https://sdd.umons.ac.be/C03Sa_ml_challenge/?login=Challenge"></iframe>
...
```{r, echo=FALSE}
knitr::include_app('https://sdd.umons.ac.be/C03Sb_ml_result', height = '700px')
```
