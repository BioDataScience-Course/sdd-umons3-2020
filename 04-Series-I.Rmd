...
Si le graphique de la fonction d'autocorrélation a des barres qui sont toutes positives significatives, cela signifie probablement qu'une tendance générale à l'augmentation domine le signal (elle est alors déjà bien souvent visible dans le graphique de la série elle-même).
