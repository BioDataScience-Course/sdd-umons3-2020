...
`r learnr("C04La_stat_slide", title = "Les Statistiques glissantes", toc = "Tutoriel : Statistiques glissantes")`
...
`r learnr("C04Lb_ts_create", title = "Création d'objet ts", toc = "Tutoriel : Objet ts")`
...
`r learnr("C04Lc_ts_manip", title = "Manipulation des séries chronologiques", toc = "Tutoriel : Manipulation des objets ts")`
