...
Le package `lubridate` comprend des fonctions très utile pour convertir des chaînes de caractères en date. Regardez par vous même pour en déduire la logique simple ci-dessous :
