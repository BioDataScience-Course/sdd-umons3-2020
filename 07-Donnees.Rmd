...
`r h5p(19, height = 270, toc = "Sélectionnez la bonne réponse")`
...
`r h5p(20, height = 270, toc = "Complétez le blanc.")`
...
assignation("sdd4_module07", part = "I",
  url = "https://github.com/BioDataScience-Course/sdd4_module07",
  course.urls = c(
    'S-BIOG-043' = "https://classroom.github.com/a/...."),
  toc = "Assignation : Conversion de caractères en date, partie I")
```
...
Cette question est cruciale pour traiter vos données. Prenons 3 petits cas pratiques théorique. 
...
En biologie, on va s'intéresser principalement à es cycles particuliers comme le cycle circadien, la succession des saisons, le cycle lunaire,...
...
```{r, echo=FALSE, results='asis'}
assignation("sdd4_module07", part = "II",
  url = "https://github.com/BioDataScience-Course/sdd4_module07",
  course.urls = c(
    'S-BIOG-043' = "https://classroom.github.com/a/...."),
  toc = "Assignation : Les données textuelles, partie II")
```
...
Ce module vous a permis de prendre connaissance des principes de bases des données temporelles et des données textuelles. Pour évaluer votre compréhension de cette matière vous aviez les exercices suivants à réaliser\ :
